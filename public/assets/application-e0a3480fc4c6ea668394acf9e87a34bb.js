...
(function() {
  $(function() {
    return $('.nav_item').click(function(e) {
      var href;
      e.preventDefault();
      if (!$(this).hasClass('brown-background')) {
        ...
        return $.ajax({
          ...
          success: function(data) {
            $('#content').html(data);
            return $("a[href='" + href + "']").addClass('brown-background');
          },
          error: function(data) {
            return alert(data);
          }
...
(function() {
  $(function() {
    return $('#contact_request').bind('click', function(e) {
      var $email, $errors, $message, $name, $re;
      e.preventDefault();
      $errors = 0;
      $name = $('#name');
      $email = $('#email');
